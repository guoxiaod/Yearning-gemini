...
if (process.env.NODE_ENV == 'development') {
    ...
    libs.url = location.protocol + '//' + domain + ':8000/api/v2';
    libs.register = location.protocol + '//' + domain + ':8000/register';
    libs.auth = location.protocol + '//' + domain + ':8000/login';
    libs.gen = location.protocol + '//' + domain + ':8000';
} else {
    libs.url = '/api/v2';
